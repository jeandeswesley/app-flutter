...
class SignInScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:
          CustomColors.customSwatchColor, //chama as cores personalizadas
          ...
          child: Column(
            children: [
              Expanded(
                child: Column(
                    mainAxisAlignment:
                        MainAxisAlignment.center, //Alinha texto ao centro
                    children: [
                      //Nome do App
                      Text.rich(
                        TextSpan(
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment
                      .stretch, //alinha o botao com os campos de input
                  children: [
                    //Email
                    ...
                    const CustomTextField(
                      icon: Icons.lock,
                      label: 'Senha',
                      isScret: true, //esconde texto da senha
                    ),
